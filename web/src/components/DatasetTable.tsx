...
//
// Self-contained (own fetch, own Run-job state/polling) so any page can
// drop this in with zero props -- extracted out of DatasetView.tsx (the
// Dataset tab) specifically so it could also be reused elsewhere; that
// page is now just this component in the standard page wrapper.
