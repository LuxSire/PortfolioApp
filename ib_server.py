...
DATASETS = [
    ...
    },
    {
        ...
        "notes": "reuses screen_data.csv as-is, only refreshes the momentum score (still hits yfinance once per ticker) -- lighter than `all`, which also re-fetches forward P/E itself",
        "network": "Yahoo Finance",
    ...
    },
    {
        "id": "screen_data",
        "path": OUTPUT_CSV,
        "label": "Screen data (raw, unranked)",
        "command": "python main.py all",
    ...
    },
    {
        ...
        "notes": "backfills grossMargins (scoring.margin_rank's third component) onto tickers already in screen_data.csv from before this factor existed -- `all`/`prices` also pick it up as a side effect for any ticker they fetch fresh",
        "network": "Yahoo Finance",
    ...
    },
    {
        ...
        "notes": "backfills heldPercentInsiders (scoring.insiders_rank's ownership component) onto tickers already in screen_data.csv from before this factor existed -- `all`/`prices` also pick it up as a side effect for any ticker they fetch fresh",
        "network": "Yahoo Finance",
